...
public class SendEmail extends extentreports{
	...
	public static boolean sendMail(String toAddresses, String subject, String msg, String fileAttachments)
		...
		String fromAddress = "tathya.gandhi@samyak.com";
		String bccAddresses = "tathya.gandhi@samyak.com";
		...
		transport.connect(hostName, "tathya.gandhi@samyak.com", "tathya.gandhi");
